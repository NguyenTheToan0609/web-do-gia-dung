...
<html lang="en">
	<head>
		...
		<link href="assets/css/green.css" rel="alternate stylesheet" title="Màu xanh">
				...
				<div class="action">
					...
					<?php } ?>
		                ...
		                <li class="lnk wishlist">
							<a class="add-to-cart" href="category.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist" title="Danh sách yêu thích">
