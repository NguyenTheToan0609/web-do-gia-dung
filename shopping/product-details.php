...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<h3 class="section-title">Loại hàng</h3>
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	<h3 class="section-title">Ưu đãi hấp dẫn</h3>
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
							    ...
							    <span class="price-before-discount">0<?php echo htmlentities($row['productPriceBeforeDiscount']);?>$</span>					
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Chất lượng :</b>  <?php echo htmlentities($rvw['quality']);?> Sao</div>
													<div class="text"><b>Giá :</b>  <?php echo htmlentities($rvw['price']);?> Sao</div>
													<div class="text"><b>Giá trị :</b>  <?php echo htmlentities($rvw['value']);?> Sao</div>
												...
												<div class="form-container">
														...
														<div class="row">
															<div class="col-sm-6">
																...
																<div class="form-group">
																	<label for="exampleInputSummary">Tóm tắt về sản phẩm <span class="astk">*</span></label>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">Đánh giá sản phẩm<span class="astk">*</span></label>
