...
<html lang="en">
	<head>
	    ...
	    <title>Trang chủ thông tin mua sắm</title>
	...
	<div class="info-boxes-inner">
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Hoàn tiền trả lại</h4>
						</div>
					</div>	
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">MIỄN PHÍ GIAO HÀNG ODER TRÊN 1000$</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Tất cả mặt hàng giảm lên đến 20% </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
		...
		<div  >
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Tất cả các sản phẩm</h3>
...
?>
	...
	<div class="product">		
		...
		<?php if($row['productAvailability']=='Còn hàng'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-info">Thêm vào giỏ hàng</a></div>
				<?php } else {?>
