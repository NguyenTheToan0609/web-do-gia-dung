...
// Mã để xóa sản phẩm khỏi danh sách yêu thích	
$wid=intval($_GET['del']);
if(isset($_GET['del']))
{
...
<html lang="vi">
	<head>
	    ...
	    <title>Danh sách yêu thích của tôi</title>
		...
		<!-- Chỉ dành cho mục đích demo. Nên gỡ bỏ trong sản xuất -->
		...
		<!-- Chỉ dành cho mục đích demo. Nên gỡ bỏ trong sản xuất : END -->
...
?>
					...
					<td class="col-md-2 close-btn">
						<a href="my-wishlist.php?del=<?php echo htmlentities($row['wid']);?>" onClick="return confirm('Bạn có chắc chắn muốn xóa không?')" class=""><i class="fa fa-times"></i></a>
					</td>
				</tr>
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">Danh sách yêu thích của bạn trống</td>
...
<?php include('includes/footer.php');?>
	...
	<!-- Dành cho mục đích demo – có thể gỡ bỏ khi đưa vào sản xuất -->
