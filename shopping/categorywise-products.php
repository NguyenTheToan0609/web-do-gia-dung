...
<html lang="en">
    <head>
        ...
        <title>Cổng mua sắm | Danh mục Cửa hàng </title>
        <!-- Favicon-->
...
{ ?>
                ...
                <div class="text-center text-white">
                    ...
                    <p class="lead fw-normal text-white-50 mb-0">Danh mục Sản phẩm/Mặt hàng</p>
                </div>
            <?php } ?>
            </div>
        </header>
...
?> 
                ...
                <?php } }  else{ ?>
     <h4 style="color:red">Không tìm thấy bản ghi nào</h4>
<?php } ?>
                </div>
            </div>
