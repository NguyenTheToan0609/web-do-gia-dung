...
.col-sm-6.col-md-4.wow.fadeInUp.animated {
...
{?>							
    ...
    <div class="products">
                        ...
                        <li class="add-cart-button btn-group">
                            <?php if ($row['productAvailability'] == 'Còn hàng') { ?>
                                <a href="category.php?page=product&action=add&id=<?php echo $row['id']; ?>">
                                    <button class="btn btn-info" type="button">Thêm vào giỏ hàng</button>
                                </a>
                            <?php } else { ?>
	  ...
	  <?php } } else {?>
		...
		<div class="col-sm-6 col-md-4 wow fadeInUp"> <h3>không tìm thấy sản phẩm nào</h3>
		</div>
