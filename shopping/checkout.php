...
echo "<script>alert('Sản phẩm đã bị xóa khỏi giỏ hàng.');</script>";
...
if($sql)
{
    echo "<script>alert('Địa chỉ của bạn đã được thêm thành công');</script>";
    echo "<script type='text/javascript'> document.location ='checkout.php'; </script>";
}
else{
...
<?php include_once('includes/header.php');?>
        ...
        <table class="table">
            <thead>
                <tr>
                <th colspan="4"><h4>Giỏ hàng của tôi</h4></th>
                </tr>
            </thead>
            <tr>
                <thead>
...
<td>
                    ...
                    <td>
                        <a href="my-cart.php?del=<?php echo htmlentities($row['cartid']);?>" onClick="return confirm('Are you sure you want to delete?')" class="btn-upper btn btn-danger">Xoá</a>
                    </td>
                </tr>
