...
<html lang="en">
	<head>
	    ...
	    <title>Cổng mua sắm | Quên mật khẩu</title>
...
?>
		...
		<label class="info-title" for="exampleInputEmail1">Địa chỉ Email <span>*</span></label>
	  	...
	  	<div class="form-group">
		  <label class="info-title" for="exampleInputPassword1">Số liên hệ <span>*</span></label>
...
<label class="info-title" for="confirmpassword">Xác nhận mật khẩu. <span>*</span></label>
		  ...
		  <button type="submit" class="btn-upper btn btn-kiểm tra chính-page-button" name="change">Thay đổi</button>
	</form>					
</div>
<!-- Sign-in -->
