...
if($query)
{
    echo "<script>alert('Hồ sơ được cập nhật thành công');</script>";
...
?>
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder"><?php echo htmlentities($result['name']);?>Hồ sơ</h1>
                </div>
...
<form method="post" name="profile">
     <div class="row">
     <div class="col-2">Tên đầy đủ</div>
