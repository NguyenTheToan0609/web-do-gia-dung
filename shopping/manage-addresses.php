...
<html lang="en">
    <head>
        ...
        <title>Cổng mua sắm | Thanh toán</title>
        <!-- Favicon-->
...
<?php include_once('includes/header.php');?>
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <h1 class="display-4 fw-bolder">Các địa chỉ đã được liệt kê</h1>
                </div>
        ...
        <section class="py-5">
            ...
            <h5>Các địa chỉ đã được liệt kê</h5>
<?php 
$uid=$_SESSION['id'];
...
<form method="post" name="address">
     ...
     <div class="row">
        ...
        <div class="col-6">
               <div class="row">
               <div class="col-9"align="center"><h5>Địa chỉ thanh toán mới</h5><br /></div>
         <hr />
     </div>
     <div class="row">
     <div class="col-3">Địa chỉ</div>
       ...
       <div class="row mt-3">
        ...
        <div class="col-6">
               <div lớp="hàng">
         <div class="col-9"align="center"><h5>Địa chỉ giao hàng mới</h5> 
            <input type="checkbox" name="adcheck" value="1"/>
            <small>Địa chỉ giao hàng giống với Địa chỉ thanh toán</small></div>
         <hr />
     </div>
     <div class="row">
         <div class="col-3">Địa chỉ</div>
