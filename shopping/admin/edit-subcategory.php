...
$_SESSION['msg']="Cập nhật danh mục phụ thành công !!";
...
<head>
	...
	<title>Quản trị| Chỉnh sửa danh mục phụ</title>
...
<div class="controls">
<input type="text" placeholder="Nhập tên danh mục"  name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" class="span8 tip" required>
</div>
</div>
