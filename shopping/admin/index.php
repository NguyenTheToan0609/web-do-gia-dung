...
<head>
	...
	<title>Cổng mua sắm | Đăng nhập Admin</title>
...
<body>
						...
						<div class="module-body">
							<div class="control-group">
								<div class="controls row-fluid">
									<input class="span12" type="text" id="inputEmail" name="username" placeholder="Tên người dùng">
								</div>
							</div>
							<div class="control-group">
								<div class="controls row-fluid">
	...
	<div class="footer">
		<div class="container">
			<b class="copyright"> Cổng mua sắm </b>
		</div>
	</div>
