...
if(strlen($_SESSION['alogin'])==0) { // Kiểm tra xem người dùng đã đăng nhập hay chưa
    ...
    if(isset($_POST['submit'])) { // Kiểm tra xem có nhấn nút gửi không
        ...
        $productimage2 = $_FILES["productimage2"]["name"]; // Lấy tên hình ảnh sản phẩm mới
                ...
                <div class="content">
                    ...
                    <div class="module">
                        <div class="module-head">
                            <h3>Cập nhật hình ảnh sản phẩm 2</h3> <!-- Tiêu đề chính -->
                        </div>
...
<?php 
$query = mysqli_query($con, "SELECT productName, productImage2 FROM products WHERE id='$pid'"); // Lấy tên sản phẩm và hình ảnh hiện tại
$cnt = 1;
...
<div class="control-group">
    ...
    <div class="controls">
        <img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage2']);?>" width="200" height="100"> <!-- Hiển thị hình ảnh sản phẩm hiện tại -->
    </div>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="file" name="productimage2" id="productimage2" class="span8 tip" required> <!-- Trường tải lên hình ảnh sản phẩm mới -->
    </div>
</div>
