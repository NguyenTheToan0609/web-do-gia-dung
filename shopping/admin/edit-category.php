...
if(isset($_POST['submit']))
{
    ...
    $_SESSION['msg']="Danh mục đã được cập nhật !!";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="controls">
<input type="text" placeholder="Nhập tên danh mục"  name="category" value="<?php echo  htmlentities($row['categoryName']);?>" class="span8 tip" required>
</div>
</div>
