<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Thương hiệu Navbar-->
    <a class="navbar-brand ps-3" href="dashboard.php">Cổng mua sắm</a>
    <!-- Nút chuyển Sidebar-->
    ...
    <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" method="post" action="search-orders.php">
        <div class="input-group">
            <input class="form-control" type="text" name="searchinputdata" placeholder="Nhập tên hoặc số đơn hàng" aria-label="Tìm kiếm..." aria-describedby="btnNavbarSearch" required />
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="admin-profile.php">Thông tin cá nhân</a></li>
