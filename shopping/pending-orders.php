...
<html lang="vi">
	<head>
		...
		<!-- Chỉ sử dụng cho mục đích demo. Cần loại bỏ khi đưa vào sản xuất -->
		<link rel="stylesheet" href="assets/css/config.css">

		<link href="assets/css/green.css" rel="alternate stylesheet" title="Màu xanh lá">
		<link href="assets/css/blue.css" rel="alternate stylesheet" title="Màu xanh dương">
		<link href="assets/css/red.css" rel="alternate stylesheet" title="Màu đỏ">
		<link href="assets/css/orange.css" rel="alternate stylesheet" title="Màu cam">
		<link href="assets/css/dark-green.css" rel="alternate stylesheet" title="Màu xanh lá đậm">
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total last-item">Hành động</th>
				</tr>
			</thead><!-- /thead -->
			
			<tbody>
			<?php 
$query = mysqli_query($con, "SELECT products.productImage1 as pimg1, 
                             ...
                             AND orders.orderStatus = 'In process'");
$cnt = 1;
...
?>
				<tr>
					...
					<td>
 				<a href="javascript:void(0);" onClick="popUpWindow('track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Theo dõi đơn hàng">Theo dõi</td>
					</tr>
<?php $cnt=$cnt+1;} ?>
...
<?php include('includes/footer.php');?>
	...
	<!-- Chỉ dùng cho mục đích demo – có thể loại bỏ khi đưa vào sản xuất -->
	...
	<!-- Chỉ dùng cho mục đích demo – có thể loại bỏ khi đưa vào sản xuất : Kết thúc -->
</body>
</html>
<?php } ?>
